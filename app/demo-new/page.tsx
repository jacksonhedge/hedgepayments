    ...
    if (entryMode.includes('-jackpot') && multipliedAmount >= 0.10) {
      ...
      setJackpotEntries(prev => ({
        ...
        [selectedPartner]: {
          ...
          '0.10': ((prev[selectedPartner] as any)?.['0.10'] || 0) + entries
        }
      }));
    }
  };
                        ...
                        {availableImages.map((imgPath, idx) => (
                          <div
                            ...
                            style={{
                              ...
                              borderRadius: '8px',
                              cursor: 'pointer',
                              border: introScreens[editingScreenIndex].image === imgPath ? '2px solid white' : '2px solid transparent'
                            }}
                          />
                        ))}
                      </div>
